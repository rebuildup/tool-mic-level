...
tool-mic-level の current release-driven development で使用する Operating Model を定義します。
...
- Browser microphone/audio data remains local; privacy claims require browser behavior evidence, not only source inspection.
